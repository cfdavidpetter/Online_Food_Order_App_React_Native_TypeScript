...
const RestaurantCard: React.FC<RestaurantProps> = ({ item, onTap }) => {
    return (
        <TouchableOpacity style={styles.container} onPress={() => onTap(item)}>
            <Image 
                style={{ width: screenWidth - 110, height: 220, borderRadius: 20, backgroundColor: '#EAEAEA' }} 
...
const styles = StyleSheet.create({
    container: { width: screenWidth - 110, height: 230, justifyContent: 'space-around', margin: 5, borderRadius: 20 },
})
